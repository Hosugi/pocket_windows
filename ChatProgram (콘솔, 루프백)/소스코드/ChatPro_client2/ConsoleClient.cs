...
namespace ChatPro_client2
{
    internal class ConsoleClient
    {
        ...
        private void SendMessage()
        {
            ...
            sendMsgListView.Add($"{DateTime.Now.ToString("[yy.MM.dd.] HH:mm:ss")} {parsingMsg}");
        ...
        //unsafe public void ptr(int* age)
        //{
        //    int a = 0;
        //    age = &a; 
        ...
        /// </summary>
        /// <param name="msglist">닉네임과 메세지를 담고있는 리스트</param>
