...
namespace calculator
{
    public partial class Form1 : Form
    {
        ...
        private void bt7_Click(object sender, EventArgs e)
        {
            ...
            else if (comma_flag && sb.Length > 1 && sb[sb.Length - 1] == '0' && !ConvertInt(sb[sb.Length - 2]))
            {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            else if (sb.Length >= 18 && sb.Length <= 28)
            {
            ...
            else if (sb.Length >= 29 && sb.Length <= 46)
            {
            ...
            else if (sb.Length >= 47 && sb.Length <= 63)
            {
